...
<body>
	...
	<div class="register-form-w3layouts">
		<!-- Form starts here -->
		<form action="registration/successful" method="post">
...
<!--CEDULA Y TELEFONO -->
		...
		<div class="main-flex-w3ls-sectns">
			...
			-->
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<input type="text" name="ci" placeholder="Cédula" pattern="^((V|E)0{1,3}[0-9]{6,8})$" title="Debe ser de la forma V0XXXXXXXX / E00XXXXXX" required="">
				</div>
				<div class="field-agileinfo-spc form-w3-agile-text2">
					<input type="text" name="phone" placeholder="Teléfono" pattern="^(\+{0,1}[0-9]+\(-[0-9]+))$" title="Télefono" required="">
				</div>
		</div>
		...
		<div class="main-flex-w3ls-sectns">
			...
			<div class="main-flex-w3ls-sectns">
				...
				<div class="field-agileinfo-spc form-w3-agile-text2">
					<input type="text" name="c_email" placeholder="Confirma tu correo" required="">
				</div>
			</div>
			...
			<div class="main-flex-w3ls-sectns">
				...
				<div class="field-agileinfo-spc form-w3-agile-text2">
					<input type="password" name="c_password" placeholder="Confirma tu Contraseña" required="">
				</div>
			</div>
			...
			<div class="radio-section">
				...
				<ul class="radio-buttons-w3-agileits">
					<li>
						<input type="radio" id="a-option" name="type" value=2 required="">
						<label for="a-option">PAD</label>
						<div class="check"></div>
					</li>
					<li>
						<input type="radio" id="b-option" name="type" value=3 required="">
				...
				<div class="clear"></div>
						...
						<div class="radio-section">
							...
							<ul class="radio-buttons-w3-agileits">
								<li>
									<input type="radio" id="a-option" name="aux_institucion" value=1 required="">
									<label for="a-option">ULA</label>
									<div class="check"></div>
								</li>
								<li>
									<input type="radio" id="b-option" name="aux_institucion" value=2 required="">
								...
								<li>
									<input type="radio" id="c-option" name="aux_institucion" value=3 required="">
